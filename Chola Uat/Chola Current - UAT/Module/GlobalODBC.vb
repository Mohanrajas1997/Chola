...
#Region "Global Declaration"
    ...
    Public Const GCPACKETSCANCOMPLETED As Integer = 65536
    Public Const GCPACKETRESCAN As Integer = 131072
    Public Const GCPACKETSCANAUDITED As Integer = 262144
    Public Const GCPACKETFINONEAUDITED As Integer = 524288
    Public Const GCPACKETFINONEDISC As Integer = 1048576
    Public Const GCPACKETFINONECHQDISC As Integer = 2097152
    Public Const GCPACKETFINONEAUTH As Integer = 4194304
    Public Const GCPACKETFINONEAUTHREJECT As Integer = 8388608
    Public Const GCPACKETFINONECORRECTION As Integer = 16777216
    Public Const GCPACKETVMSCORRECTION As Integer = 33554432
    Public Const GCPACKETDISC As Integer = 67108864
    ...
    'FinnOne desc
    Public Const GCFINNONECHQDATE As Integer = 1
    Public Const GCFINNONECHQNO As Integer = 2
    Public Const GCFINNONEAMOUNT As Integer = 4
    Public Const GCFINNONEAGGREMENTNO As Integer = 8
    Public Const GCFINNONEACCNO As Integer = 16

    Private Declare Function ShellExecute Lib "shell32.dll" Alias "ShellExecuteA" (ByVal hwnd As Long, ByVal lpOperation As String, ByVal lpFile As String, ByVal lpParameters As String, ByVal lpDirectory As String, ByVal nShowCmd As Long) As Long

    Public gProjectName As String = "Vault Management System"
    Public softcode As String = "CHOLA"
...
#End Region
    ...
    Public Sub UpdateAlmara(ByVal GNSAREFNO As String, ByVal Mode As String)
        ...
        Sqlstr &= " WHERE (" & Replace(Replace(GNSAREFNO.ToUpper, "P", ""), "N", "") & " BETWEEN almaraentry_refnofrom AND almaraentry_refnoto)"
    ...
    Public Sub LogPacket(ByVal GNSAREFNO As String, ByVal StatusFlag As Integer, Optional ByVal PacketGid As Long = 0, _
        ...
        lssql &= " and packet_status & " & GCPACKETDISC & " = 0"
