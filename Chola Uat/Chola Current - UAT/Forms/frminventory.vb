Public Class frminventory
    ...
    Private Sub LoadData()
        ...
        Dim lsCond As String = ""
            ...
            lsSql = " SELECT almaraentry_cupboardno as 'Cupboard No',almaraentry_shelfno as 'Shelf No',almaraentry_boxno as 'Box No',packet_gnsarefno as 'GNSAREF#',shortagreement_no as 'Agreement No#' "
