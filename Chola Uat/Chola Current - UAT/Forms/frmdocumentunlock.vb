Public Class frmdocumentunlock
    ...
    Private Sub LoadData()
        ...
        If lsfiletype = "PDC" Then
            lsSql = " select tf.pdc_gid,pdc_gnsarefno as 'GNSAREF#',pdc_shortpdc_parentcontractno as 'Short Agreement No',pdc_draweename as 'Drawee Name' " & _
        ...
        Else
            ...
            lsSql = " select tf.spdc_gid,spdc_gnsarefno as 'GNSAREF#',spdc_shortagreementno as 'Short Agreement No'" & _
    ...
    Private Sub dgvsummary_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvsummary.CellDoubleClick
        ...
        ElseIf lsfiletype = "PDC" Then
            ...
            lsSql &= " lock_by=null"
            lsSql &= " where 1=1"
            lsSql &= " and pdc_shortpdc_parentcontractno='" & dgvsummary.Rows(e.RowIndex).Cells(1).Value & "'"
