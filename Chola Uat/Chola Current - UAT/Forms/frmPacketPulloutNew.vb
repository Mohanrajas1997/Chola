Public Class frmPacketPulloutNew
    ...
    Private Sub SaveRecords()
        ...
        If txtId.Text = "" Then
            ...
            If lnPktId > 0 Then
                ...
                'changes done on 25-10-2023
                msSql = ""
                msSql &= " update chola_trn_tspdcentry set "
                msSql &= " ecsmandatepullout_oldcount = ecsmandatepulloutcount, "
                msSql &= " ecsmandatepulloutcount = spdcentry_ecsmandatecount "
                msSql &= " where spdcentry_packet_gid = " & lnPktId
    ...
    Private Sub ListAll(ByVal PacketPulloutId As Long)
        ...
        msSql = ""
        msSql &= " select a.*,b.packet_gnsarefno,c.shortagreement_no from chola_trn_tpacketpullout as a "
    ...
    Private Sub btnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFind.Click
        ...
        Try
            SearchDialog = New Search(gOdbcConn, _
                             " select a.packetpullout_gid as 'SPDC Pullout Id',b.packet_gnsarefno as 'Packet No',c.shortagreement_no as 'Short Agreement No'," & _
                             ...
                             " a.packetpullout_gid,b.packet_gnsarefno,c.shortagreement_no,a.packetpullout_reason,a.packetpullout_postedon,a.packetpullout_postedby", _
    ...
    Private Sub UndoPacket(ByVal PktId As Long)
        ...
        If PktId > 0 Then
            ...
            msSql = ""
            msSql &= " update chola_trn_tspdcentry set "
            msSql &= " ecsmandatepulloutcount = ecsmandatepullout_oldcount, "
            msSql &= " ecsmandatepullout_oldcount = 0 "
            msSql &= " where spdcentry_packet_gid = " & PktId
