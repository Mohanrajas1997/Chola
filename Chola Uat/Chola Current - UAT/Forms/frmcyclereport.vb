Public Class frmcyclereport
    ...
    Private Sub LoadData()
        ...
        lssql &= "  shortagreement_no as 'Agreement No',packet_gnsarefno as 'GNSA REF#',type_name as 'Product',chq_no as 'Cheque No',date_format(chq_date,'%d-%m-%Y') as 'Cheque Date', "
