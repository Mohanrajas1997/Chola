...
Public Class frmPost
    ...
    Private Function PostFinoneAuthDateWithPacket() As Long
        ...
        lsSql = ""
        lsSql &= " select head_gid,head_inward_gid,head_systemauthdate,head_shortagreementno from chola_trn_tpdcfilehead "
        ...
        With ds.Tables("finone")
            For i = 0 To .Rows.Count - 1
                ...
                lsShortAgmtNo = .Rows(i).Item("head_shortagreementno")
                ...
                If lnInwardId = 0 Then
                    lsSql &= " where inward_shortagreementno = " & lsShortAgmtNo & " "
