Public Class frmchqentrydelete
    ...
    Private Sub LoadData()
        ...
        lsSql = " select chqentry_gid,@slno:= @slno + 1 as 'SL No',packet_gnsarefno as 'GNSA REF#',shortagreement_no as 'Short Agreement No',chq_no as 'Cheque No',date_format(chq_date,'%d-%m-%Y') as 'Cheque Date',chq_amount as 'Amount',"
        ...
        If txtagreementno.Text <> "" Then
            lsSql &= " and shortagreement_no='" & txtagreementno.Text & "'"
        End If
