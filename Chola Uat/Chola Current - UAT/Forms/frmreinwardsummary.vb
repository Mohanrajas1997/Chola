Public Class frmreinwardsummary
    ...
    Private Sub btnrefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnrefresh.Click
        ...
        If txtgnsarefno.Text <> "" Then
            Dim frmentry As New frmreinward(dgvsummary.Rows(0).Cells("Short Agreement No").Value.ToString, dgvsummary.Rows(0).Cells("GNSA REF#").Value.ToString)
            frmentry.ShowDialog()
        End If
    End Sub
    ...
    Private Sub dgvsummary_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvsummary.CellDoubleClick
        If e.RowIndex < 0 Then
            Exit Sub
        End If
        Dim frmentry As New frmreinward(dgvsummary.Rows(e.RowIndex).Cells("Short Agreement No").Value.ToString, dgvsummary.Rows(e.RowIndex).Cells("GNSA REF#").Value.ToString)
        frmentry.ShowDialog()
        txtgnsarefno.Text = ""
        LoadData()
    End Sub
