Public Class frmStockMisNew
    ...
    Private Sub btnrefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRefresh.Click
        ...
        Select Case cbopaymode.Text
            ...
            Case "SPDC AVAILABLE"
                Call LoadSpdcAvailable()
            Case "MANDATE AVAILABLE"
                Call LoadmandateAvailable()
    ...
    Private Sub LoadPdcAvailable()
        ...
        Try
            ...
            If lsCond = "" Then
                lsCond &= " and 1 = 2 "
            Else
                lsCond &= " and chq_status & " & (GCCLOSURE Or GCPACKETPULLOUT Or GCPULLOUT Or GCCHQRETRIEVAL Or GCPRESENTATIONDE) & " = 0 "
            End If

            lsSql = ""
            lsSql &= " select "
            lsSql &= " 'PDC' as 'Type',"
            lsSql &= " count(distinct packet_gid) as 'Packet',"
            lsSql &= " count(distinct packet_agreement_gid) as 'Agreement',"
            lsSql &= " count(*) as 'Total' "
            lsSql &= " from chola_trn_tpdcentry e"
            lsSql &= " inner join chola_trn_tpacket p on p.packet_gid=e.chq_packet_gid"
    ...
    Private Sub LoadSpdcAvailable()
        ...
        Try
            ...
            If lsCond = "" Then
                lsCond &= " and 1 = 2 "
            Else
                lsCond &= " and chqentry_status & " & (GCCLOSURE Or GCPACKETPULLOUT Or GCPULLOUT Or GCCHQRETRIEVAL Or GCPRESENTATIONDE) & " = 0 "
            End If
    ...
    Private Sub LoadmandateAvailable()
        btnRefresh.Enabled = False
        Dim ds As New DataSet
        Dim lsSql As String = ""
        Dim lsCond As String = ""
        ...
        Try
            ...
            lsSql = ""
            lsSql &= " select "
            lsSql &= " 'MANDATE' as 'Type',"
            lsSql &= " count(distinct packet_gid) as 'Packet',"
            lsSql &= " count(distinct packet_agreement_gid) as 'Agreement',"
            lsSql &= " sum(spdcentry_ecsmandatecount - ecsmandatepulloutcount) as 'Available' "
