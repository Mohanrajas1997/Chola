Public Class frmSearchEngine
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Try
            ' Find Agreement Id
            If txtAgrNo.Text <> "" Then
                lsSql = ""
                lsSql &= " select agreement_gid from chola_mst_tagreement "
                lsSql &= " where shortagreement_no = '" & QuoteFilter(txtAgrNo.Text) & "' "
            ...
            lsFld &= " fn_get_disc_desc(s.scan_disc_value,'P') as 'VMC Chq Desc',"
            ...
            lsSql &= " left join chola_trn_tbox b on p.packet_box_gid = b.box_gid "
            lsSql &= " left join chola_mst_tagreement a on p.packet_agreement_gid = a.agreement_gid "
            lsSql &= " left join chola_trn_tscan as s on s.scan_chq_gid=c.entry_gid and s.scan_packet_gid=p.packet_gid and s.scan_visibility='Y'"
            lsSql &= " where true "
            lsSql &= lsCond
            ...
            lsFld &= " fn_get_disc_desc(d.scan_disc_value,'S') as 'VMC Chq Desc',"
            lsFld &= " d.scan_finnone_disc as 'FinnOne Chq Desc',"
            ...
            lsSql &= " left join chola_trn_tbox b on p.packet_box_gid = b.box_gid "
            lsSql &= " left join chola_mst_tagreement a on p.packet_agreement_gid = a.agreement_gid "
            lsSql &= " left join chola_trn_tscan as d on d.scan_chq_gid=s.chqentry_gid and d.scan_packet_gid=p.packet_gid and d.scan_visibility='Y'"
            lsSql &= " where true "
            lsSql &= lsCond
            ...
            lsSql &= " left join chola_mst_tagreement a on f.pdc_shortpdc_parentcontractno = a.shortagreement_no "
            lsSql &= " left join chola_trn_tpdcfilehead h on h.head_file_gid = f.file_mst_gid and h.head_shortagreementno = f.pdc_shortpdc_parentcontractno "
