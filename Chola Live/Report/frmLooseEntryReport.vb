Public Class frmLooseEntryReport
    ...
    Private Sub btnRefresh_Click(ByVal sender As System.Object, ByVal l As System.EventArgs) Handles btnRefresh.Click
        ...
        Try
            ...
            lsSql = ""
            lsSql &= " select b.batch_gid as 'Batch Gid',b.batch_no as 'Batch No',l.loosechqentry_sno as 'Loose Chq SNo',c.chq_date as 'Chq Date',c.chq_no as 'Chq No',c.chq_amount as 'Chq Amount',"
            ...
            lsSql &= " left join chola_trn_tbatch as b on c.chq_batch_gid = b.batch_gid "
            lsSql &= " where true "
            lsSql &= lsCond
