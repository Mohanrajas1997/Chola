        ...
        If ds.Tables("pkt").Rows.Count > 0 Then
            ...
            Select Case mnFlag
                ...
                Case GCOLDSWAPPKTPULLOUT
                    ...
                    lsSql &= " ecsmandatepullout_oldcount = ecsmandatepulloutcount, "
                    lsSql &= " ecsmandatepulloutcount = spdcentry_ecsmandatecount "
                    lsSql &= " where spdcentry_packet_gid = " & lnPktId
                ...
                Case GCOLDSWAPPKTPULLOUTUNDO
                    ...
                    lsSql = ""
                    lsSql &= " update chola_trn_tspdcentry set "
                    lsSql &= " ecsmandatepulloutcount = ecsmandatepullout_oldcount, "
                    lsSql &= " ecsmandatepullout_oldcount = 0 "
                    lsSql &= " where spdcentry_packet_gid = " & lnPktId
