Public Class frmMain
    Private Sub frmMain_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            'ServerDetails = "Driver={Mysql odbc 3.51 Driver};Server=146.56.55.230;port=3306;DataBase=chola;uid=root;pwd=Flexi@123"
            '  ServerDetails = "Driver={Mysql odbc 3.51 Driver};Server=192.168.0.154;port=3306;DataBase=Chola;uid=root;pwd=Gnsa@123"
            'ServerDetails = "Driver={Mysql odbc 3.51 Driver};Server=169.38.77.180;port=3306;DataBase=chola;uid=root;pwd=Flexi@123"
    ...
    Private Sub mnuScanAudiQueue_Click(sender As System.Object, e As System.EventArgs) Handles mnuScanAudiQueue.Click
        Dim objfrm As New frmScanAuditQueue
        objfrm.MdiParent = Me
        objfrm.Show()
    End Sub

    Private Sub FinnOneToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles FinnOneToolStripMenuItem.Click
        Dim objfrm As New frmFinnoneImageQueue
        objfrm.MdiParent = Me
        objfrm.Show()
    End Sub

    Private Sub DiscReportToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles DiscReportToolStripMenuItem.Click
        Dim objfrm As New frmDiscReport
        objfrm.MdiParent = Me
        objfrm.Show()
    End Sub

    Private Sub VMSCorrectionQueueToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles VMSCorrectionQueueToolStripMenuItem.Click
        Dim objfrm As New frmVMSCorrectionQueue
        objfrm.MdiParent = Me
        objfrm.Show()
    End Sub

    Private Sub FinnOneAuthQueueToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles FinnOneAuthQueueToolStripMenuItem.Click
        Dim objfrm As New frmFinnOneAuthQueue
        objfrm.MdiParent = Me
        objfrm.Show()
    End Sub

    Private Sub SearchEngineeImageBasedToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchEngineeImageBasedToolStripMenuItem.Click
        Dim objfrm As New frmSearchEngineeImagebased
        objfrm.MdiParent = Me
        objfrm.Show()
    End Sub

    Private Sub mnuSwap_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuSwap.Click

    End Sub

    Private Sub mnuUpdatePacketEntry_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuUpdatePacketEntry.Click
        Dim frm As New frmUpdatePktEntryForScanCases
        frm.ShowDialog()
    End Sub

    Private Sub mnuMandatePulloutDump_Click(sender As Object, e As EventArgs) Handles mnuMandatePulloutDump.Click
        Dim objfrm As New frmMandatePullout
        objfrm.MdiParent = Me
        objfrm.Show()
    End Sub

    Private Sub mnuChequePulloutDump_Click(sender As Object, e As EventArgs) Handles mnuChequePulloutDump.Click
        Dim objfrm As New frmchqpullout
        objfrm.MdiParent = Me
        objfrm.Show()
    End Sub

    Private Sub mnuUndoChequePulloutDump_Click(sender As Object, e As EventArgs) Handles mnuUndoChequePulloutDump.Click
        Dim objfrm As New frmUndoChqPullout
        objfrm.MdiParent = Me
        objfrm.Show()
    End Sub

    Private Sub InwardTallyReportToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles InwardTallyReportToolStripMenuItem.Click
        Dim objfrm As New frmInwardTallyReport
        objfrm.MdiParent = Me
        objfrm.Show()
    End Sub

    Private Sub mnuMandateCountUpdation_Click(sender As Object, e As EventArgs) Handles mnuMandateCountUpdation.Click
        Dim objfrm As New frmMandatecountUpdation
        objfrm.MdiParent = Me
        objfrm.Show()
    End Sub

    Private Sub LooseEntryBatchedToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LooseEntryBatchedToolStripMenuItem.Click
        Dim frm As New frmLooseChqEntryForBatch
        frm.ShowDialog()
    End Sub

    Private Sub BatchDepositSlipToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BatchDepositSlipToolStripMenuItem.Click
        Dim objfrm As New frmBatchDepositSlip
        objfrm.MdiParent = Me
        objfrm.Show()
    End Sub

    Private Sub RegenerateDepositSlipToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles RegenerateDepositSlipToolStripMenuItem.Click
        Dim objfrm As New frmRegenerateDepositSlip
        objfrm.MdiParent = Me
        objfrm.Show()
    End Sub
End Class
