Public Class frmbatchentry
    ...
    Private Sub btnrefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnrefresh.Click
        ...
        lssql = " select entry_gid,agreement_gid,@slno := @slno + 1 as 'SL No',packet_gnsarefno as 'GNSA REF#',shortagreement_no as 'Short Agreement No',chq_no as 'Cheque No',date_format(chq_date,'%d-%m-%Y') as 'Cheque Date',chq_amount as 'Amount',"
