Public Class frmScanAuditQueue
    ...
    Private Sub btnrefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnrefresh.Click
        ...
        If txtgnsarefno.Text <> "" Then
            ...
            Dim frmImageEntry As New frmImageBaseEntry(dgvsummary.Rows(0).Cells("GNSA REF#").Value.ToString, dgvsummary.Rows(0).Cells("Short Agreement No").Value.ToString)
    ...
    Private Sub dgvsummary_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvsummary.CellContentDoubleClick
        ...
        Dim frmImageEntry As New frmImageBaseEntry(dgvsummary.Rows(e.RowIndex).Cells("GNSA REF#").Value.ToString, dgvsummary.Rows(e.RowIndex).Cells("Short Agreement No").Value.ToString)
        frmImageEntry.ShowDialog()
        'txtgnsarefno.Text = ""
