Public Class frmctsreport
    ...
    Private Sub LoadData1()
        ...
        lsSql &= " a.almaraentry_boxno as 'Box No',a.packet_gnsarefno as 'GNSA REF#',a.shortagreement_no 'Agreement No',"
        ...
        lsSql &= " almaraentry_boxno,packet_gnsarefno,shortagreement_no,count(*) as tot_chq,"
        ...
        lsSql &= " select almaraentry_cupboardno,almaraentry_shelfno,"
        lsSql &= " almaraentry_boxno,packet_gnsarefno,shortagreement_no,spdcentry_spdccount as tot_chq,"
    ...
    Private Sub LoadDataOld()
        ...
        If cbotype.Text = "PDC" Then
            ...
            lsSql &= " almaraentry_boxno as 'Box No',packet_gnsarefno as 'GNSA REF#',shortagreement_no 'Agreement No',count(*) as 'Total Cheque',"
        ...
        Else
            ...
            lsSql &= " if(a.`Total Cheque`= a.CTS,'CTS',if(a.`Total Cheque`=a.`Non CTS`,'Non CTS','Partial')) as 'Status' "
            lsSql &= " from (select almaraentry_cupboardno as 'Cupboard No',almaraentry_shelfno as 'Shelf No',"
            lsSql &= " almaraentry_boxno as 'Box No',packet_gnsarefno as 'GNSA REF#',shortagreement_no 'Agreement No',spdcentry_spdccount as 'Total Cheque',"
