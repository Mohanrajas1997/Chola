Public Class frmInwardMisNew
    ...
    Private Sub LoadData()
        ...
        lsSql &= " sum(if(ifnull(packet_status,0) & " & GCPACKETRESCAN & " > 0,1,0)) as 'Re Scan',"
        lsSql &= " sum(if(ifnull(packet_status,0) & " & GCPACKETCHEQUEENTRY & " > 0,1,0)) as 'Chq DE Completed',"
        'lsSql &= " sum(if(ifnull(packet_status,0) & " & GCPACKETSCANAUDITED & " > 0,1,0)) as 'Chq DE VMS Image Completed',"
    ...
    Private Sub btnDay2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDay2.Click
        ...
        With objxlexport
            ...
            lsSql &= " inner join chola_trn_tpdcfile as p on p.file_mst_gid = h.head_file_gid and p.pdc_shortpdc_parentcontractno = h.head_shortagreementno "
