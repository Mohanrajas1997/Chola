...
Public Class frmFileReport
    ...
    Private Sub LoadPDCData()
        ...
        lssql = " select distinct pdc_shortpdc_parentcontractno "
        ...
        For i As Integer = 0 To objdt.Rows.Count - 1
            ...
            lssql = "  select if(pdc_status_flag is null,'',pdc_status_flag) as 'Flag',packet_gnsarefno as 'GNSA Ref No#',pdc_contractno as 'Contract No',pdc_shortpdc_parentcontractno as 'Dump Parent No',shortagreement_no as 'Entry Parent No',"
            ...
            lssql &= " from chola_trn_tpdcfile a "
            lssql &= " inner join chola_mst_tagreement on shortagreement_no=pdc_shortpdc_parentcontractno "
            lssql &= " left join chola_mst_tfile as mf on mf.file_gid=a.file_mst_gid"
            ...
            If txtchqno.Text.Trim <> "" Then
                lssql &= " and pdc_chqno='" & txtchqno.Text.Trim & "'"
            End If
            lssql &= " and pdc_shortpdc_parentcontractno='" & objdt.Rows(i)(0).ToString() & "'"
            ...
            lssql &= " left join chola_trn_tpacket on packet_agreement_gid=agreement_gid "
            lssql &= " left join chola_trn_tpdcfile b on shortagreement_no=pdc_shortpdc_parentcontractno and pdc_shortpdc_parentcontractno='" & objdt.Rows(i)(0).ToString & "' and pdc_chqno=chq_no"
            lssql &= " where pdc_gnsarefno is null "
            lssql &= " and shortagreement_no='" & objdt.Rows(i)(0).ToString & "'"
