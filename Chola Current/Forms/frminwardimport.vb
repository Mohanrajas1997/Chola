...
Public Class frminwardimport
    ...
    Private Sub Importexcel(ByVal FilePath As String, ByVal SheetName As String)
        ...
        lsFldNmesInfo = "S#No|PRODUCT|APPLICATION_ID|APPL_FORM_NO|BRANCH|AGREEMENTNO|CUSTOMER NAME|PAY_MODE|" & _
                        "Pdc|Spdc|mandate|LMS_AUTH_DATE|TENURE|FIRST_EMI_DATE|Instl-Mode|	REMARKS|PARENT AGREEMENTNO|Comb agr|RECEIVED_DATE"
        ...
        Try
            ...
            For liIndex As Integer = 0 To lExcelDatatable.Rows.Count - 1
                ...
                Try
                    ...
                    lssql &= " inward_mandate,inward_lmsauthdate,inward_tenure,inward_firstemidate,inward_installmode,inward_dumpremarks,inward_parent_agreementno,inward_compagr,inward_receiveddate)"
                    lssql &= " values ("
                    lssql &= lsFileMstGid & ","
                    ...
                    lssql &= "'" & QuoteFilter(lExcelDatatable.Rows(liIndex).Item("PARENT AGREEMENTNO").ToString.Trim) & "',"
