Public Class frmmismatchreport
    ...
    Private Sub LoadData()
        ...
        lsSql = ""
        lsSql &= " select a.packet_gid,@slno:= @slno + 1 as 'SL No',packet_gnsarefno as 'GNSA REF#',agreement_no as 'Agreement No',shortagreement_no as 'Short Agreement No',packet_mode as 'Packet Mode' "
