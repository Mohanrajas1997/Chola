Public Class frmclosurereport
    ...
    Private Sub LoadData()
        ...
        If txtagreementno.Text <> "" Then
            lsCond &= " and shortagreement_no = '" & QuoteFilter(txtagreementno.Text) & "' "
        End If
        ...
        lsSql &= " packet_gnsarefno as 'GNSA Ref#',shortagreement_no as 'Agreement Number',"
    ...
    Private Sub ClosureMis()
        ...
        If txtagreementno.Text <> "" Then lsCond &= " and shortagreement_no = '" & QuoteFilter(txtagreementno.Text) & "' "
