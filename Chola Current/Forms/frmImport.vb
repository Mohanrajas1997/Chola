...
#End Region
    ...
    Private Sub ShortAgreementNoQry()
        ...
        Try
            ...
            lsSql &= " left join chola_mst_tagreement as a on a.shortagreement_no = q.short_agreement_no "
    ...
    Sub ImpSwapShortAgreementFile()
        ...
        lsFldName(3) = "SHORT AGREEMENT NO"
            ...
            With fExcelDatatable
                ...
                While i <= .Rows.Count - 1
                    With .Rows(i)
                        ...
                        lsShortAgmntNo = Format(Val(Mid(QuoteFilter(.Item("SHORT AGREEMENT NO").ToString), 1, 7)), "000000")
                        If Val(lsShortAgmntNo) = 0 Then lsShortAgmntNo = ""
                        ...
                        If lsShortAgmntNo = "" Then
                            lbInsertFlag = False
                            lsDiscRemark &= "Blank Short Agreement No,"
                        End If

                        ' Find agreement_gid
                        fsSql = ""
                        fsSql &= " select agreement_gid from chola_mst_tagreement "
                        fsSql &= " where shortagreement_no= '" & lsShortAgmntNo & "' "

                        lnAgmntId = Val(gfExecuteScalar(fsSql, gOdbcConn))
