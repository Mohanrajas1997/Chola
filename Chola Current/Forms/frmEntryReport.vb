...
Public Class frmEntryReport
    ...
    Private Sub LoadPDCData()
        ...
        For i As Integer = 0 To objdt.Rows.Count - 1
            ...
            lssql = "  select packet_gnsarefno as 'GNSA Ref No#',pdc_contractno as 'Contract No',pdc_shortpdc_parentcontractno as 'Dump Parent No',shortagreement_no as 'Entry Parent No',"
