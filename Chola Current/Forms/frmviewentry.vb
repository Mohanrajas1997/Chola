Public Class frmviewentry
    ...
    Private Sub LoadData()
        ...
        For i As Integer = 0 To dttable.Rows.Count - 1
            ...
            If lnFinoneId = 0 Then
                ...
                lssql &= " and a.pdc_shortpdc_parentcontractno='" & dttable.Rows(i).Item("shortagreement_no").ToString & "'"
    ...
    Private Sub LoadDataOld()
        ...
        For i As Integer = 0 To dttable.Rows.Count - 1
            ...
            lssql &= " and pdc_shortpdc_parentcontractno='" & dttable.Rows(i).Item("shortagreement_no").ToString & "'"
